...
// Defined by Orange
#define STR_CMD_GET_DATA_RATE "mac get dr"
#define STR_CMD_GET_NUMBER_GATEWAY "mac get gwnb"
#define STR_CMD_LINK_CHECK "linkchk "

// Added by Microchip
#define STR_CMD_FACTORY_RESET "sys factoryRESET"
#define STR_CMD_NO_DCYCLE_0	"mac set ch dcycle 0 0"
#define STR_CMD_NO_DCYCLE_1 "mac set ch dcycle 1 0"
#define STR_CMD_NO_DCYCLE_2 "mac set ch dcycle 2 0"
