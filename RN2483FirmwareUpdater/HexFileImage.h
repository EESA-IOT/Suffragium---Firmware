...
//#define HEXFILE_RN2903AU_103a
#define HEXFILE_RN2903AU_105RC2
...
#elif defined(HEXFILE_RN2903AU_103a)
#include "HexFileImage2903A_AU915v103a.h"
#elif defined(HEXFILE_RN2903AU_105RC2)
#include "HexFileImage2903A_AU915v105RC2.h"
#else
